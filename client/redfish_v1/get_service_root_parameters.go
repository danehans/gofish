...
// NewGetServiceRootParamsWithContext creates a new GetServiceRootParams object
...
func (o *GetServiceRootParams) WithContext(ctx context.Context) *GetServiceRootParams {
	o.SetContext(ctx)
	return o
}
