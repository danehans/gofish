...
// NewListResetTypesParamsWithContext creates a new ListResetTypesParams object
...
func (o *ListResetTypesParams) WithContext(ctx context.Context) *ListResetTypesParams {
	o.SetContext(ctx)
	return o
}
